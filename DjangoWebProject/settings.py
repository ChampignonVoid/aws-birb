...
SECRET_KEY = '648bbbe3-09df-47ea-b051-140ca5c8128e'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'registration', 'templates'),
                 os.path.join(BASE_DIR, 'DjangoWebProject', 'templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
if not DEBUG:
    DATABASES = {
        'default' : {
            ...
            'NAME': 'd4s205ctoo1ac2',
            'USER': 'yfdcnacnhclxja',
            'PASSWORD': '7310e41e804f471ab424e30d95603e5e828f6afb0706116968bfd4230f4a4a1f',
...
# Media files (Images, video, binary)
